...
Route::get('/bible_study/bfam/series/lesson_1_9',[Studycontroller::class,('Con_1_9')])->name('con_1-9');
Route::get('/bible_study/bfam/series/lesson_1_10',[Studycontroller::class,('Con_1_10')])->name('con_1-10');
