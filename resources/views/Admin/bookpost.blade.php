                    ...
                    <div class="v-post">
                        ...
                        <form action="{{route('verpost')}}" method="POST">
                            ...
                            <div class="mb-3 col-sm-7">
                                <label for="formGroupExampleInput" class="form-label">စာအုပ်အမည်</label>
                                <input type="text" name="verse" class="form-control" id="formGroupExampleInput" >
                            </div>
                            <div class="mb-3 col-sm-7">
                                <label for="formGroupExampleInput" class="form-label">စာအုပ်အမျိုးအစား</label>
                                <input type="text" name="verse" class="form-control" id="formGroupExampleInput" >
                            </div>
                            <div class="mb-3 col-sm-7">
                                <label for="formGroupExampleInput" class="form-label">စာရေးသူအမည်</label>
                                <input type="text" name="verse" class="form-control" id="formGroupExampleInput" >
                            </div>
                            <div class="mb-3 ">
                                <label for="formGroupExampleInput" class="form-label">အကြောင်းအရာ</label>
