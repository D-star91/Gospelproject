        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            ...
            <ul class="navbar-nav ml-auto nav-flex-icons">
                <li class="nav-item me-3 me-lg-0">
                    <a href="" class="navbr-font-br"><i class="fas fa-sign-in-alt"></i></a>
                <li class="nav-item me-3 me-lg-0">
            ...
            <div class="row">
                ...
                <div class="col-5">
                  <form class="form-inline my-4 ">
                    ...
                    <input type="text" class="form-control ml-5 mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Email address">
