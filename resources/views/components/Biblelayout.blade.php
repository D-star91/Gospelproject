...
<body class="bg-secondary">
    <nav class="navbar navbar-light bg-warning">
        <a class="navbr-font-sty" href="{{route('index')}}">
            <img src="{{asset('Image/loyallogo3.png')}}" height="45" alt="mdb logo" class="mr-2 ml-5">LOYAL BIBLE
        </a>
      </nav>
        <!--Navbar -->
      ...
      <div class="container">
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <li class="nav-item">
                        <a class="navbr-font-br me-5"  href="" data-toggle="modal" data-target="#exampleModal1">OLD TESTAMENT</a>
                    </li>
                </li>
                <li class="nav-item">
                    <li class="nav-item">
                        <a class="navbr-font-br me-5" href="" data-toggle="modal" data-target="#exampleModal2">NEW TESTAMENT</a>
                    </li>
                </li>
            </ul>
